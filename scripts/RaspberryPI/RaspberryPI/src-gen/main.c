...
static IPConnection brick_connection_singleton_1;
RGBLEDButton rgbLEDButton_shared_instance_2;
uint16_t greenValue_shared_instance_2;
static rumblepad_configuration_t* rumblepad_config_singleton_4;
uint16_t redValue_shared_instance_2;
static uint16_t rumble_strong_shared_instance_10 = 0;
static uint16_t rumble_weak_shared_instance_10 = 0;
uint16_t blueValue_shared_instance_2;
static DistanceUS ultra_sonic_device_instance_13;
static uint16_t ultra_sonic_value_instance_13 = 0;
static uint64_t ultra_sonic_last_cb_time_instance_13 = 0;
RGBLEDButton rgbLEDButton_shared_instance_14;
uint16_t greenValue_shared_instance_14;
static int actuator_pwm_singleton_16 = -1;
static LaserRangeFinder laser_range_device_instance_17;
static uint16_t laser_range_value_instance_17 = 0;
static uint64_t laser_range_last_cb_time_instance_17 = 0;
...
static void ultra_sonic_callback_instance_13(uint16_t distance, void *data) {
	ultra_sonic_value_instance_13 = distance;
	ultra_sonic_last_cb_time_instance_13 = time_util_get_current_micros();
}

static inline bool ultra_sonic_is_invalid_instance_13() {
	return time_util_get_elapsed_micros_since(ultra_sonic_last_cb_time_instance_13) >= ((uint64_t)1 * SECONDS_IN_MICROS);
}

static void laser_range_callback_instance_17(uint16_t distance, void *data) {
laser_range_value_instance_17 = distance;
laser_range_last_cb_time_instance_17 = time_util_get_current_micros();
}
...
static void worker() {
	...
	DistanceToFrontUS1_ID_5278 = ultra_sonic_value_instance_20;
	} else {
	noval_DistanceToFrontUS1_ID_5278 = true;
	}
	noval_DistanceToFrontLaser_ID_5474 = false;
	DistanceToFrontLaser_ID_5474 = laser_range_value_instance_17;
	noval_VelocityIn_ID_5264 = false;
	VelocityIn_ID_5264 = getVelocity();
	if (!(ultra_sonic_is_invalid_instance_13())) {
	noval_DistanceToFrontUS2_ID_16717 = false;
	DistanceToFrontUS2_ID_16717 = ultra_sonic_value_instance_13;
	} else {
	...
	temp_actuator_device_set_target(actuator_pwm_singleton_16, 0, SteeringValue_ID_14149);
	...
	redValue_shared_instance_2 = 0;
	} else {
	redValue_shared_instance_2 = Red_Right_ID_19242;
	}
	if (noval_Green_Right_ID_19249) {
	greenValue_shared_instance_2 = 0;
	} else {
	greenValue_shared_instance_2 = Green_Right_ID_19249;
	}
	if (noval_Blue_Right_ID_19256) {
	blueValue_shared_instance_2 = 0;
	} else {
	blueValue_shared_instance_2 = Blue_Right_ID_19256;
	}
	...
	rgb_led_button_set_color(&rgbLEDButton_shared_instance_2, redValue_shared_instance_2, greenValue_shared_instance_2, blueValue_shared_instance_2);
...
int main(int argc, char** argv) {
	...
	ipcon_create(&brick_connection_singleton_1);
	if(ipcon_connect(&brick_connection_singleton_1, BRICK_HOST, BRICK_PORT) < 0) {
	perror("Failed to connect to brick sub-system.");
	return 1;
	}

	rgb_led_button_create(&rgbLEDButton_shared_instance_2, "Dnn", &brick_connection_singleton_1);
	...
	rumblepad_config_singleton_4 = malloc(sizeof(rumblepad_configuration_t));
	rumblepad_config_singleton_4->device_id = "/dev/input/event0";
	rumblepad_config_singleton_4->waiting_sleep_in_micros = 50;
	rumblepad_config_singleton_4->axis_callback = NULL;
	rumblepad_config_singleton_4->button_callback = NULL;
	rumblepad_initialize(rumblepad_config_singleton_4);
	...
	distance_us_create(&ultra_sonic_device_instance_13, "zr", &brick_connection_singleton_1);
	distance_us_register_callback(&ultra_sonic_device_instance_13, DISTANCE_US_CALLBACK_DISTANCE, (void*)ultra_sonic_callback_instance_13, NULL);
	distance_us_set_distance_callback_period(&ultra_sonic_device_instance_13, 10);
	rgb_led_button_create(&rgbLEDButton_shared_instance_14, "Dmb", &brick_connection_singleton_1);
	actuator_pwm_singleton_16 = temp_actuator_initialize("/dev/Maestro0");
	// initialize LaserRangeSensor
	laser_range_finder_create(&laser_range_device_instance_17, "CQe", &brick_connection_singleton_1);
	laser_range_finder_enable_laser(&laser_range_device_instance_17);
	laser_range_finder_register_callback(&laser_range_device_instance_17, LASER_RANGE_FINDER_CALLBACK_DISTANCE, (void*)laser_range_callback_instance_17, NULL);
	laser_range_finder_set_distance_callback_period(&laser_range_device_instance_17, 10);
	distance_us_create(&ultra_sonic_device_instance_20, "DZB", &brick_connection_singleton_1);
