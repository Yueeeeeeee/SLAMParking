...
typedef enum Enum_Message_Type{
	platoon_ID_46451 = 0,
	fuse_ID_46453 = 1,
	no_message_ID_46460 = 2,
	handshake_ID_47920 = 3,
	split_ID_50354 = 4,
	leave_ID_50355 = 5,
	heartbeat_ID_51359 = 6,
	newLeader_ID_57755 = 7
	#ifdef USE_GCC
} __attribute__ ((packed)) GEN_TYPE_Message_Type;
#else
} GEN_TYPE_Message_Type;
#endif


extern GEN_TYPE_Message_Type platoon();

extern GEN_TYPE_Message_Type fuse();

extern GEN_TYPE_Message_Type no_message();

extern GEN_TYPE_Message_Type handshake();

extern GEN_TYPE_Message_Type split();

extern GEN_TYPE_Message_Type leave();

extern GEN_TYPE_Message_Type heartbeat();

extern GEN_TYPE_Message_Type newLeader();

extern char* Message_TypeToString(GEN_TYPE_Message_Type value);
...
typedef enum Enum_PlatoonState{
	off_ID_48498 = 0,
	follower_ID_48499 = 1,
	leader_ID_48500 = 2,
	fuseStarter_ID_48501 = 3,
	fusing_ID_50309 = 4,
	leaving_ID_50634 = 5,
	splitting_ID_50635 = 6,
	handshaking_ID_56096 = 7
	#ifdef USE_GCC
} __attribute__ ((packed)) GEN_TYPE_PlatoonState;
#else
} GEN_TYPE_PlatoonState;
#endif


extern GEN_TYPE_PlatoonState off();

extern GEN_TYPE_PlatoonState follower();

extern GEN_TYPE_PlatoonState leader();

extern GEN_TYPE_PlatoonState fuseStarter();

extern GEN_TYPE_PlatoonState fusing();

extern GEN_TYPE_PlatoonState leaving();

extern GEN_TYPE_PlatoonState splitting();

extern GEN_TYPE_PlatoonState handshaking();

extern char* PlatoonStateToString(GEN_TYPE_PlatoonState value);
...
typedef struct Struct_MessageHeartbeat {
	GEN_TYPE_int  id;
	GEN_TYPE_int  leaderID;
	GEN_TYPE_int  platoonID;
	GEN_TYPE_int  tailID;
} GEN_TYPE_MessageHeartbeat;
...
typedef struct Struct_MessageFuse {
	...
	GEN_TYPE_listParticipants  listSenderPlatoonMembers;
...
extern GEN_TYPE_int get_nof_participants(GEN_TYPE_listParticipants participants);

extern GEN_TYPE_listParticipants fuse_participants(GEN_TYPE_listParticipants fuseListParticipants,GEN_TYPE_listParticipants platoonListParticipants);

extern GEN_TYPE_int get_position(GEN_TYPE_listParticipants participants,GEN_TYPE_int id);

extern GEN_TYPE_listParticipants split_participants(GEN_TYPE_listParticipants splitList,GEN_TYPE_int splitPos);

extern GEN_TYPE_int get_tailID(GEN_TYPE_listParticipants participants);

extern GEN_TYPE_listParticipants split_participantsLeader(GEN_TYPE_listParticipants splitList,GEN_TYPE_int splitPos);

extern GEN_TYPE_listParticipants leave_participants(GEN_TYPE_listParticipants platoonListParticipants,GEN_TYPE_int id);
