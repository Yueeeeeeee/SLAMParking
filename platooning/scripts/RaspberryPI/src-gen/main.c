...
static rumblepad_configuration_t* rumblepad_config_singleton_2;
static int actuator_pwm_singleton_3 = -1;
static IPConnection brick_connection_singleton_6;
...
static uint16_t rumble_strong_shared_instance_12 = 0;
static uint16_t rumble_weak_shared_instance_12 = 0;
static LaserRangeFinder laser_range_device_instance_13;
static uint16_t laser_range_value_instance_13 = 0;
static uint64_t laser_range_last_cb_time_instance_13 = 0;
uint16_t redValue_shared_instance_14;
uint16_t redValue_shared_instance_7;
uint16_t blueValue_shared_instance_14;
static DistanceUS ultra_sonic_device_instance_18;
static uint16_t ultra_sonic_value_instance_18 = 0;
static uint64_t ultra_sonic_last_cb_time_instance_18 = 0;
...
static void laser_range_callback_instance_13(uint16_t distance, void *data) {
laser_range_value_instance_13 = distance;
laser_range_last_cb_time_instance_13 = time_util_get_current_micros();
}

static void ultra_sonic_callback_instance_18(uint16_t distance, void *data) {
	ultra_sonic_value_instance_18 = distance;
	ultra_sonic_last_cb_time_instance_18 = time_util_get_current_micros();
}

static inline bool ultra_sonic_is_invalid_instance_18() {
	return time_util_get_elapsed_micros_since(ultra_sonic_last_cb_time_instance_18) >= ((uint64_t)1 * SECONDS_IN_MICROS);
}
...
static void worker() {
	...
	if (!(ultra_sonic_is_invalid_instance_18())) {
	noval_DistanceToFrontUS1_ID_5278 = false;
	DistanceToFrontUS1_ID_5278 = ultra_sonic_value_instance_18;
	} else {
	noval_DistanceToFrontUS1_ID_5278 = true;
	}
	noval_DistanceToFrontLaser_ID_5474 = false;
	DistanceToFrontLaser_ID_5474 = laser_range_value_instance_13;
	...
	DistanceToFrontUS2_ID_16717 = ultra_sonic_value_instance_11;
	} else {
	...
	temp_actuator_device_set_target(actuator_pwm_singleton_3, 0, SteeringValue_ID_14149);
	...
	rumble_weak_shared_instance_12 = 0;
	} else {
	rumble_weak_shared_instance_12 = RumbleWeak_ID_17086;
	}
	if (noval_RumbleStrong_ID_17079) {
	rumble_strong_shared_instance_12 = 0;
	} else {
	rumble_strong_shared_instance_12 = RumbleStrong_ID_17079;
	}
	if (noval_Red_Left_ID_19221) {
	redValue_shared_instance_7 = 0;
	} else {
	redValue_shared_instance_7 = Red_Left_ID_19221;
	}
	if (noval_Green_Left_ID_19228) {
	greenValue_shared_instance_7 = 0;
	} else {
	greenValue_shared_instance_7 = Green_Left_ID_19228;
	}
	if (noval_Blue_Left_ID_19235) {
	blueValue_shared_instance_7 = 0;
	} else {
	blueValue_shared_instance_7 = Blue_Left_ID_19235;
	}
	if (noval_Red_Right_ID_19242) {
	redValue_shared_instance_14 = 0;
	} else {
	redValue_shared_instance_14 = Red_Right_ID_19242;
	}
	if (noval_Green_Right_ID_19249) {
	greenValue_shared_instance_14 = 0;
	} else {
	greenValue_shared_instance_14 = Green_Right_ID_19249;
	}
	if (noval_Blue_Right_ID_19256) {
	blueValue_shared_instance_14 = 0;
	} else {
	blueValue_shared_instance_14 = Blue_Right_ID_19256;
	}
	...
	rumblepad_set_rumble(rumble_strong_shared_instance_12, rumble_weak_shared_instance_12, cycle_time * 0.9, 0);
...
int main(int argc, char** argv) {
	...
	rumblepad_config_singleton_2 = malloc(sizeof(rumblepad_configuration_t));
	rumblepad_config_singleton_2->device_id = "/dev/input/event0";
	rumblepad_config_singleton_2->waiting_sleep_in_micros = 50;
	rumblepad_config_singleton_2->axis_callback = NULL;
	rumblepad_config_singleton_2->button_callback = NULL;
	rumblepad_initialize(rumblepad_config_singleton_2);

	actuator_pwm_singleton_3 = temp_actuator_initialize("/dev/Maestro0");
	...
	ipcon_create(&brick_connection_singleton_6);
	if(ipcon_connect(&brick_connection_singleton_6, BRICK_HOST, BRICK_PORT) < 0) {
	...
	distance_us_create(&ultra_sonic_device_instance_11, "zr", &brick_connection_singleton_6);
	...
	laser_range_finder_create(&laser_range_device_instance_13, "CQe", &brick_connection_singleton_6);
	laser_range_finder_enable_laser(&laser_range_device_instance_13);
	laser_range_finder_register_callback(&laser_range_device_instance_13, LASER_RANGE_FINDER_CALLBACK_DISTANCE, (void*)laser_range_callback_instance_13, NULL);
	laser_range_finder_set_distance_callback_period(&laser_range_device_instance_13, 10);
	distance_us_create(&ultra_sonic_device_instance_18, "DZB", &brick_connection_singleton_6);
	distance_us_register_callback(&ultra_sonic_device_instance_18, DISTANCE_US_CALLBACK_DISTANCE, (void*)ultra_sonic_callback_instance_18, NULL);
	distance_us_set_distance_callback_period(&ultra_sonic_device_instance_18, 10);
	init_System_ID_4789();
