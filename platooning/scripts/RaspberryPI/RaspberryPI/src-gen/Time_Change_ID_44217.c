...
GEN_TYPE_DriverAssistanceCommands DA_States_ID_44261;

GEN_TYPE_boolean noval_DA_States_ID_44261;
...
static GEN_TYPE_boolean fire_transition_Rising_flank_ID_44243(){
	if (!(noval_DA_States_ID_44261 == true) && DA_States_ID_44261.timePlus == pressed()) {
...
static GEN_TYPE_boolean fire_transition_Falling_flank_ID_44246(){
	if (noval_DA_States_ID_44261 == true || DA_States_ID_44261.timePlus == notPressed()) {
		noval_TimeChange_ID_44288 = false;
...
static GEN_TYPE_boolean fire_transition_Rising_flank_ID_44249(){
	if (!(noval_DA_States_ID_44261 == true) && DA_States_ID_44261.timeMinus == pressed()) {
		noval_TimeChange_ID_44288 = false;
		TimeChange_ID_44288 = -1;
...
static GEN_TYPE_boolean fire_transition_Falling_flank_ID_44252(){
	if (noval_DA_States_ID_44261 == true || DA_States_ID_44261.timeMinus == notPressed()) {
		noval_TimeChange_ID_44288 = false;
		TimeChange_ID_44288 = 0;
