...
static rumblepad_configuration_t* rumblepad_config_singleton_3;
static IPConnection brick_connection_singleton_4;
RGBLEDButton rgbLEDButton_shared_instance_5;
uint16_t blueValue_shared_instance_5;
RGBLEDButton rgbLEDButton_shared_instance_7;
uint16_t redValue_shared_instance_7;
uint16_t redValue_shared_instance_5;
uint16_t greenValue_shared_instance_7;
uint16_t greenValue_shared_instance_5;
static DistanceUS ultra_sonic_device_instance_14;
static uint16_t ultra_sonic_value_instance_14 = 0;
static uint64_t ultra_sonic_last_cb_time_instance_14 = 0;
uint16_t blueValue_shared_instance_7;
static uint16_t rumble_strong_shared_instance_16 = 0;
static uint16_t rumble_weak_shared_instance_16 = 0;
static int actuator_pwm_singleton_17 = -1;
static LaserRangeFinder laser_range_device_instance_18;
static uint16_t laser_range_value_instance_18 = 0;
static uint64_t laser_range_last_cb_time_instance_18 = 0;
static DistanceUS ultra_sonic_device_instance_20;
static uint16_t ultra_sonic_value_instance_20 = 0;
static uint64_t ultra_sonic_last_cb_time_instance_20 = 0;


static void ultra_sonic_callback_instance_14(uint16_t distance, void *data) {
	ultra_sonic_value_instance_14 = distance;
	ultra_sonic_last_cb_time_instance_14 = time_util_get_current_micros();
}

static inline bool ultra_sonic_is_invalid_instance_14() {
	return time_util_get_elapsed_micros_since(ultra_sonic_last_cb_time_instance_14) >= ((uint64_t)1 * SECONDS_IN_MICROS);
}

static void laser_range_callback_instance_18(uint16_t distance, void *data) {
laser_range_value_instance_18 = distance;
laser_range_last_cb_time_instance_18 = time_util_get_current_micros();
}

static void ultra_sonic_callback_instance_20(uint16_t distance, void *data) {
	ultra_sonic_value_instance_20 = distance;
	ultra_sonic_last_cb_time_instance_20 = time_util_get_current_micros();
}

static inline bool ultra_sonic_is_invalid_instance_20() {
	return time_util_get_elapsed_micros_since(ultra_sonic_last_cb_time_instance_20) >= ((uint64_t)1 * SECONDS_IN_MICROS);
}
...
static void worker() {
	...
	if (!(ultra_sonic_is_invalid_instance_14())) {
	noval_DistanceToFrontUS1_ID_5278 = false;
	DistanceToFrontUS1_ID_5278 = ultra_sonic_value_instance_14;
	} else {
	noval_DistanceToFrontUS1_ID_5278 = true;
	}
	noval_DistanceToFrontLaser_ID_5474 = false;
	DistanceToFrontLaser_ID_5474 = laser_range_value_instance_18;
	noval_VelocityIn_ID_5264 = false;
	VelocityIn_ID_5264 = getVelocity();
	if (!(ultra_sonic_is_invalid_instance_20())) {
	noval_DistanceToFrontUS2_ID_16717 = false;
	DistanceToFrontUS2_ID_16717 = ultra_sonic_value_instance_20;
	} else {
	...
	temp_actuator_device_set_target(actuator_pwm_singleton_17, 0, SteeringValue_ID_14149);
	...
	rumble_weak_shared_instance_16 = 0;
	} else {
	rumble_weak_shared_instance_16 = RumbleWeak_ID_17086;
	}
	if (noval_RumbleStrong_ID_17079) {
	rumble_strong_shared_instance_16 = 0;
	} else {
	rumble_strong_shared_instance_16 = RumbleStrong_ID_17079;
	}
	if (noval_Red_Left_ID_19221) {
	redValue_shared_instance_5 = 0;
	} else {
	redValue_shared_instance_5 = Red_Left_ID_19221;
	}
	if (noval_Green_Left_ID_19228) {
	greenValue_shared_instance_5 = 0;
	} else {
	greenValue_shared_instance_5 = Green_Left_ID_19228;
	}
	if (noval_Blue_Left_ID_19235) {
	blueValue_shared_instance_5 = 0;
	} else {
	blueValue_shared_instance_5 = Blue_Left_ID_19235;
	}
	if (noval_Red_Right_ID_19242) {
	redValue_shared_instance_7 = 0;
	} else {
	redValue_shared_instance_7 = Red_Right_ID_19242;
	}
	if (noval_Green_Right_ID_19249) {
	greenValue_shared_instance_7 = 0;
	} else {
	greenValue_shared_instance_7 = Green_Right_ID_19249;
	}
	if (noval_Blue_Right_ID_19256) {
	blueValue_shared_instance_7 = 0;
	} else {
	blueValue_shared_instance_7 = Blue_Right_ID_19256;
	}
	...
	rumblepad_set_rumble(rumble_strong_shared_instance_16, rumble_weak_shared_instance_16, cycle_time * 0.9, 0);
	rgb_led_button_set_color(&rgbLEDButton_shared_instance_5, redValue_shared_instance_5, greenValue_shared_instance_5, blueValue_shared_instance_5);
	rgb_led_button_set_color(&rgbLEDButton_shared_instance_7, redValue_shared_instance_7, greenValue_shared_instance_7, blueValue_shared_instance_7);
...
int main(int argc, char** argv) {
	...
	rumblepad_config_singleton_3 = malloc(sizeof(rumblepad_configuration_t));
	rumblepad_config_singleton_3->device_id = "/dev/input/event0";
	rumblepad_config_singleton_3->waiting_sleep_in_micros = 50;
	rumblepad_config_singleton_3->axis_callback = NULL;
	rumblepad_config_singleton_3->button_callback = NULL;
	rumblepad_initialize(rumblepad_config_singleton_3);

	ipcon_create(&brick_connection_singleton_4);
	if(ipcon_connect(&brick_connection_singleton_4, BRICK_HOST, BRICK_PORT) < 0) {
	perror("Failed to connect to brick sub-system.");
	return 1;
	}

	rgb_led_button_create(&rgbLEDButton_shared_instance_5, "Dmb", &brick_connection_singleton_4);
	rgb_led_button_create(&rgbLEDButton_shared_instance_7, "Dnn", &brick_connection_singleton_4);
	...
	distance_us_create(&ultra_sonic_device_instance_14, "DZB", &brick_connection_singleton_4);
	distance_us_register_callback(&ultra_sonic_device_instance_14, DISTANCE_US_CALLBACK_DISTANCE, (void*)ultra_sonic_callback_instance_14, NULL);
	distance_us_set_distance_callback_period(&ultra_sonic_device_instance_14, 10);
	actuator_pwm_singleton_17 = temp_actuator_initialize("/dev/Maestro0");
	// initialize LaserRangeSensor
	laser_range_finder_create(&laser_range_device_instance_18, "CQe", &brick_connection_singleton_4);
	laser_range_finder_enable_laser(&laser_range_device_instance_18);
	laser_range_finder_register_callback(&laser_range_device_instance_18, LASER_RANGE_FINDER_CALLBACK_DISTANCE, (void*)laser_range_callback_instance_18, NULL);
	laser_range_finder_set_distance_callback_period(&laser_range_device_instance_18, 10);
	initUSB("/dev/vesc", B115200);
	distance_us_create(&ultra_sonic_device_instance_20, "zr", &brick_connection_singleton_4);
	distance_us_register_callback(&ultra_sonic_device_instance_20, DISTANCE_US_CALLBACK_DISTANCE, (void*)ultra_sonic_callback_instance_20, NULL);
	distance_us_set_distance_callback_period(&ultra_sonic_device_instance_20, 10);
	init_System_ID_4789();
