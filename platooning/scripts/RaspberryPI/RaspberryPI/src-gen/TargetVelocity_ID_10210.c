...
GEN_TYPE_DriverAssistanceCommands DA_States_ID_45628;

GEN_TYPE_boolean noval_DA_States_ID_45628;
...
void perform_step_TargetVelocity_ID_10210(){
	...
	if (!(noval_DA_States_ID_45628 == true) && DA_States_ID_45628.acc == On()) {
